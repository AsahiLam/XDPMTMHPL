...
public class CourseInstructorBLL {
    ...
    public boolean updateCourseInstructor(CourseInstructor ci, int oldPersonID, String oldCourseTitle) {
    ...
    public boolean deleteCourseInstructor(int idPerson, String courseTitle) {
        CourseInstructorDAL courseInstructorDAL = new CourseInstructorDAL();
    ...
    public List<CourseInstructor> getCoursesByPersonID(int PersonID) {
        return courseInstructorDAL.getCoursesByPersonID(PersonID);
    }
}
